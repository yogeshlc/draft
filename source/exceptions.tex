...
struct D : public A, public B {
    int * p = new int[n];
    // \tcode{D::D()} potentially-throwing, as the new operator may throw \tcode{bad_alloc} or \tcode{bad_array_new_length}
...
\pnum
An exception specification is considered to be \term{needed} when:

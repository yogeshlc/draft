...
is ``\grammarterm{derived-declarator-type-list} \tcode{T}'',
the type of the \grammarterm{declarator-id} in \tcode{D}
is ``\grammarterm{derived-declarator-type-list} \tcode{noexcept}\opt
function of (\grammarterm{parameter-declaration-clause} )
...
\indextext{array, parameter~of}%
\indextext{type!array, parameter~of}%
of type ``array of \tcode{T}'' or
\indextext{function, parameter~of}%
\indextext{type!function, parameter~of}%

...
variable with a unique name \tcode{\placeholder{e}} is introduced. If the
...
\begin{ncbnf}
attribute-specifier-seqopt decl-specifier-seq ref-qualifieropt \tcode{e} brace-or-equal-initializer \terminal{;}
\end{ncbnf}
...
\begin{note}
The top-level \grammarterm{cv-qualifier}{s} of \tcode{T} are \cv.
\end{note}
\begin{example}
\begin{codeblock}
  auto f() -> int(&)[2];

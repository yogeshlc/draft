...
A non-type
\grammarterm{template-parameter}
\indextext{array, template parameter~of}%
\indextext{type!array, template parameter~of}%
of type ``array of \tcode{T}'' or
\indextext{function, template parameter~of}%
\indextext{type!function, template parameter~of}%

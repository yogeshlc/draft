...
\pnum
For an \grammarterm{noexcept-specifier} of a function template
...
an \grammarterm{noexcept-specifier} immediately follows the namespace
...
default arguments, or \grammarterm{noexcept-specifier}{s} of the class member functions,
...
\nontermdef{deduction-guide}\br
    template-name \terminal{(} parameter-declaration-clause \terminal{) ->} simple-template-id \terminal{;}
\end{bnf}

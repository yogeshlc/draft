...
\pnum
A thread of execution \term{makes progress} when an execution step occurs or a
...
\pnum
For a thread of execution providing \term{concurrent forward progress guarantees},

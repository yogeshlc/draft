...
A a1 = { i, i };  // error: cannot deduce from rvalue reference in \#2,
                  // and \#1 is not a candidate during deduction from copy-initialization.
...
A a5 = {0, 1};    // error: \#3 deduces to \tcode{A<int\&>} and \#1 \& \#2 result in same parameter constructors.
A a6{0,1};        // OK, \#4 deduces to \tcode{A<int>} and \#2 initializes
A a7 = {0, i};    // error: \#3 deduces to \tcode{A<int\&>}
A a8{0,i};        // error: \#3 deduces to \tcode{A<int\&>}

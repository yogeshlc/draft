...
namespace std {
  ...
  struct pair {
    ...
    pair(pair&&) = default;
    constexpr pair();
    \term{EXPLICIT} constexpr pair(const T1& x, const T2& y);
    template<class U, class V> \term{EXPLICIT} constexpr pair(U&& x, V&& y);
    template<class U, class V> \term{EXPLICIT} constexpr pair(const pair<U, V>& p);
    template<class U, class V> \term{EXPLICIT} constexpr pair(pair<U, V>&& p);
...
namespace std {
  ...
  public:
    ...
    constexpr tuple();
    \term{EXPLICIT} constexpr tuple(const Types&...); // only if \tcode{sizeof...(Types) >= 1}
    template <class... UTypes>
      \term{EXPLICIT} constexpr tuple(UTypes&&...); // only if \tcode{sizeof...(Types) >= 1}

    tuple(const tuple&) = default;
    tuple(tuple&&) = default;

    template <class... UTypes>
      \term{EXPLICIT} constexpr tuple(const tuple<UTypes...>&);
    template <class... UTypes>
      \term{EXPLICIT} constexpr tuple(tuple<UTypes...>&&);

    template <class U1, class U2>
      \term{EXPLICIT} constexpr tuple(const pair<U1, U2>&);       // only if \tcode{sizeof...(Types) == 2}
    template <class U1, class U2>
      \term{EXPLICIT} constexpr tuple(pair<U1, U2>&&);            // only if \tcode{sizeof...(Types) == 2}

    // allocator-extended constructors
    template <class Alloc>
      tuple(allocator_arg_t, const Alloc& a);
    template <class Alloc>
      \term{EXPLICIT} tuple(allocator_arg_t, const Alloc& a, const Types&...);
    template <class Alloc, class... UTypes>
      \term{EXPLICIT} tuple(allocator_arg_t, const Alloc& a, UTypes&&...);
    template <class Alloc>
      tuple(allocator_arg_t, const Alloc& a, const tuple&);
    template <class Alloc>
      tuple(allocator_arg_t, const Alloc& a, tuple&&);
    template <class Alloc, class... UTypes>
      \term{EXPLICIT} tuple(allocator_arg_t, const Alloc& a, const tuple<UTypes...>&);
    template <class Alloc, class... UTypes>
      \term{EXPLICIT} tuple(allocator_arg_t, const Alloc& a, tuple<UTypes...>&&);
    template <class Alloc, class U1, class U2>
      \term{EXPLICIT} tuple(allocator_arg_t, const Alloc& a, const pair<U1, U2>&);
    template <class Alloc, class U1, class U2>
      \term{EXPLICIT} tuple(allocator_arg_t, const Alloc& a, pair<U1, U2>&&);
...
\begin{itemdecl}
\term{EXPLICIT} constexpr tuple(const Types&...);
\end{itemdecl}
...
\begin{itemdecl}
template <class... UTypes>
  \term{EXPLICIT} constexpr tuple(UTypes&&... u);
\end{itemdecl}
...
\indexlibrary{\idxcode{tuple}!constructor}%
\begin{itemdecl}
template <class... UTypes> \term{EXPLICIT} constexpr tuple(const tuple<UTypes...>& u);
\end{itemdecl}
...
\indexlibrary{\idxcode{tuple}!constructor}%
\begin{itemdecl}
template <class... UTypes> \term{EXPLICIT} constexpr tuple(tuple<UTypes...>&& u);
\end{itemdecl}
...
\indexlibrary{\idxcode{pair}}%
\begin{itemdecl}
template <class U1, class U2> \term{EXPLICIT} constexpr tuple(const pair<U1, U2>& u);
\end{itemdecl}
...
\indexlibrary{\idxcode{pair}}%
\begin{itemdecl}
template <class U1, class U2> \term{EXPLICIT} constexpr tuple(pair<U1, U2>&& u);
\end{itemdecl}

...
\pnum
\effects
Equivalent to return \tcode{bool(x) ? *x == v : false}.
\end{itemdescr}
...
\pnum
\effects
Equivalent to return \tcode{bool(x) ? v == *x : false}.
\end{itemdescr}
...
\pnum
\effects
Equivalent to return \tcode{bool(x) ? *x != v : true}.
\end{itemdescr}
...
\pnum
\effects
Equivalent to return \tcode{bool(x) ? v != *x : true}.
\end{itemdescr}

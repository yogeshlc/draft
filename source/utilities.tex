...
\pnum
Note A: It is \impldef{support for extended alignment} whether any extended alignment is
...
the same types as \tcode{decay_t<T1>} and \tcode{decay_t<T2>}, respectively.
  ...
  \item Otherwise, let \tcode{C} denote the same type, if any,
     ...
     \end{note}
  \end{itemize}
In either case, the member typedef-name type shall denote

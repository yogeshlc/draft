...
\indextext{attribute!maybe_unused}
...
\pnum
A name or entity declared without the \tcode{maybe_unused} attribute can
later be
redeclared with the attribute and vice versa. An entity is considered
marked after

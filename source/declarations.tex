...
\grammarterm{enumerator}{s}, depending on the syntax). In such cases, and
...
described above, and if the type that replaces the occurrence of
\tcode{auto} is not the same in each deduction, the program is
ill-formed.
...
\nontermdef{alignment-specifier}\br
  ...
  \terminal{alignas (} assignment-expression \terminal{...}\opt \terminal{)}
\end{bnf}

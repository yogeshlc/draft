...
template is the address of a function tcode{F} that, when invoked, has the same
...
\enterexample
\begin{codeblock}
// \tcode{v} and \tcode{m} are odr-used but do not occur in a \grammarterm{constant-expression} within the nested

...
unless \tcode{N == 0} or \tcode{is_swappable<T>::value} is \tcode{true}.
...
\indexlibrary{\idxcode{swap}!\idxcode{array}}%
\begin{itemdecl}
void swap(array& y) noexcept(is_nothrow_swappable<T>::value);
\end{itemdecl}
  ...
  public:
    ...
    void      swap(unordered_map&)
      noexcept(allocator_traits<Allocator>::is_always_equal::value &&
               ...
               is_nothrow_swappable<Pred>::value);
    void      clear() noexcept;
...
namespace std {
  ...
  public:
    ...
    void swap(queue& q) noexcept(is_nothrow_swappable<Container>::value)
...
\remarks
This function shall not participate in overload resolution
unless \tcode{is_swappable<Container>::value} is \tcode{true}.
...
namespace std {
  ...
  public:
    ...
    void pop();
    void swap(priority_queue& q) noexcept(is_nothrow_swappable<Container>::value &&
                                          is_nothrow_swappable<Compare>::value)
...
\remarks
This function shall not participate in overload resolution
unless \tcode{is_swappable<Container>::value} is \tcode{true} and
\tcode{is_swappable<Compare>::value} is \tcode{true}.

...
are \term{shared mutex types}. Shared mutex types shall meet the requirements of
...
namespace std {
  ...
  public:
     ...
     typedef implementation-defined native_handle_type; // See \ref{thread.req.native}
     native_handle_type native_handle(); // See \ref{thread.req.native}
  };
}
\end{codeblock}

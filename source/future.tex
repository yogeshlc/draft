...
\pnum
For compatibility with prior \Cpp{} International Standards, a \tcode{static constexpr}
data member may be redundantly redeclared outside the class with no initializer. This usage is deprecated.
\begin{example}
\begin{codeblock}
struct A {

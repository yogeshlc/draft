...
\item
\tcode{UniformRandomBitGenerator} shall meet the requirements of a uniform random bit generator type (\ref{rand.req.urng})
...
The type
\tcode{UniformRandomBitGenerator} shall meet the requirements of a
